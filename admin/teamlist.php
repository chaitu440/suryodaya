...
<table class="table">
    ...
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<td>
                    <a href="deleteteam.php?partnerid=' . $row["partnerid"] . '" class="btn btn-danger">Delete</a>
                    <a href="teamupdate.php?partnerid=' . $row["partnerid"] . '" class="btn btn-primary">Update</a>
                </td>';
            echo '</tr>';
        }
    } else {
